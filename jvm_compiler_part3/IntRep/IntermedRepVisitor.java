        ...
        try{
          ...
          new FileOutputStream(outputFileName+ ".ir"), "utf-8"));
            functionsSignaturesMap = new HashMap<String, IRFunctionSignature>();
             writer.write("PROG " + outputFileName + "\n\n");
            if (p != null) {
            ...
            if (p != null) {
                ...
                for(int i =0; i < numberOfFunction; i++) {
                    ...
                    currentFunctionSignature.createIRFile(writer);
...
**/
    ...
    public Temp visit(FunctionCall f)  {
        ...
        //System.out.println(functionReturnType.getType().toString());
        ...
        if(functionReturnType.getType().equals(new VoidType(0,0))){
            ...
            in = new FunctionCallIrExpression(callArgumentTempList, f.id.idName);
        } else {
            ...
            in = new FunctionCallIrExpression(callArgumentTempList, f.id.idName, resultTemp);
        }
